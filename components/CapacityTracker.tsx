...
export function CapacityTracker() {
        ...
        try {
            ...
            if (res.ok) {
                ...
                toastRef.current?.show({
                    ...
                    detail: `Capacidad diaria actualizada a ${hours}h.`,
                    life: 3000,
                });
            } else {
                toastRef.current?.show({
                    ...
                    detail: 'No se pudo actualizar la capacidad diaria.',
                    life: 4000,
                });
            }
        } catch {
    ...
    const percentage = config && config.estimated_hours > 0
        ? Math.min((config.busy_hours / config.estimated_hours) * 100, 100)
        : 0;
                ...
                >
                    <div className="flex align-items-center justify-content-between flex-wrap gap-3">
                        ...
                        <div className="flex align-items-center gap-2">
                            ...
                            <div>
                                <div className="text-sm font-semibold text-700">Tiempo disponible hoy</div>
                                <div className="text-xs text-500">
                                    {config.busy_hours}h ocupadas&nbsp;·&nbsp;{config.available_hours}h libres de {config.estimated_hours}h
                                </div>
                            </div>
                        </div>
